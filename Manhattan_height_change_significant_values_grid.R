...
setwd("/storage/group/zps5164/default/sms8526/722g_Breeds_Project/Final_pvalues_phenotypes/Normalized_Height_pvalues/Final_chunks_pvalues/")
...
setwd("/storage/group/zps5164/default/sms8526/722g_Breeds_Project/Final_pvalues_phenotypes/Normalized_Height_pvalues/Final_chunks_pvalues_small/")
...
setwd("/storage/group/zps5164/default/sms8526/722g_Breeds_Project/Final_pvalues_phenotypes/Normalized_Height_pvalues/Final_chunks_pvalues_large/")
...
text( y = c(4.8,5.6,4.9), x=c(339000900,1750000000,1769999000), labels = c("CERS3","SNTA1","CBFA2T2"), col = c("purple","purple","purple"), cex = c(0.8,0.8,0.8))
...
text( y = c(4.8,4.35,4.74,5.9,5.3,5.4,4.9), x=c(339000900,339900900,900000900,900000900,900000900,1750000000,1769999000), labels = c("TTC23","IGF1R","RPH3AL","PITPNA","SLC43A2","SNTA1","CBFA2T2"), col = "purple", cex = 0.8)
...
text(y=4.7, x=975000900,labels = "PRR16", col = "purple", cex = 0.8)
}
...
postscript(file= "/storage/group/zps5164/default/sms8526/722g_Breeds_Project/scripts/scripts_R_pvalues/Normalized_Manhattan_plots_newest/plots_and_tables/Manhattan_height_grid.eps", height = 9, width = 6.5)
...
ggsave("/storage/group/zps5164/default/sms8526/722g_Breeds_Project/scripts/scripts_R_pvalues/Normalized_Manhattan_plots_newest/plots_and_tables/Manhattan_height_grid.png", plot_png,height = 9, width =6.5, dpi = 600, units ="in" )

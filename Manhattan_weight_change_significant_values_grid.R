...
setwd("/storage/group/zps5164/default/sms8526/722g_Breeds_Project/Final_pvalues_phenotypes/Normalized_Weight_pvalues/Final_chunks_pvalues/")
...
setwd("/storage/group/zps5164/default/sms8526/722g_Breeds_Project/Final_pvalues_phenotypes/Normalized_Weight_pvalues/Final_chunks_pvalues_small/")
...
setwd("/storage/group/zps5164/default/sms8526/722g_Breeds_Project/Final_pvalues_phenotypes/Normalized_Weight_pvalues/Final_chunks_pvalues_large/")
...
text( y = c(4.7,4.8,5.4,6.0,5.48,5.0,4.6,7.5,7.2), x=c(340000900, 1530000000,1510000000,1750000000,1769999000,1750000000,1760000000,1995000000,2150000000), labels = c("CERS3","ZXDC","TXNRD3","SNTA1","CBFA2T2","ZNF341","CHMP4B","PKD2","SPIDR"), col = "purple", cex = 0.8)
...
text( y = c(5.4,4.8,5.6,6.2,4.8), x=c(900000900,900000900,1750000000,1769999000,1750000000), labels = c("PITPNA","SLC43A2","SNTA1","CBFA2T2","ZNF341"), col = "purple", cex = 0.8)

}

plot3 <- function(){  par(mar = c(4.5, 4, 2.3, 0.75))
...
text(y=c(6.7,6.75), x=c(1900000000,2150000000),labels = c("PRR16","SPIDR"), col = "purple", cex = 0.8)
}
...
postscript(file= "/storage/group/zps5164/default/sms8526/722g_Breeds_Project/scripts/scripts_R_pvalues/Normalized_Manhattan_plots_newest/plots_and_tables/Manhattan_weight_grid.eps", height = 9, width = 6.5)
...
ggsave("/storage/group/zps5164/default/sms8526/722g_Breeds_Project/scripts/scripts_R_pvalues/Normalized_Manhattan_plots_newest/plots_and_tables/Manhattan_weight_grid.png", plot_png,height = 9, width =6.5, dpi = 600, units ="in" )
